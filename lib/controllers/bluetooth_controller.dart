...
class BluetoothController {
  ...
  set bluetoothState(bool value) => _bluetoothState = value;

  bool get isConnecting => _isConnecting;
  set isConnecting(bool value) => _isConnecting = value;

  BluetoothConnection? get connection => _connection;
  set connection(BluetoothConnection? value) => _connection = value;

  List<BluetoothDevice> get devices => _devices;
  set devices(List<BluetoothDevice> value) => _devices = value;

  BluetoothDevice? get deviceConnected => _deviceConnected;
  set deviceConnected(BluetoothDevice? value) => _deviceConnected = value;
